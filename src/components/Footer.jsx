...
import { FaFacebookF, FaHeadset, FaHospital, FaInstagram, FaMailBulk } from 'react-icons/fa'
import logoImg from "../assets/logo.png";

const Footer = () => {
  return (
    <div id="footer" className="bg-[#254133] p-5 md:p-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        ...
        <div className="w-full">
          ...
          <div className="w-full">
            <h2 className="text-xl font-bold text-[#BF8B01] uppercase">
              Redes Sociais
            </h2>
