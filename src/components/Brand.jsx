...
import bgHero from "../assets/brand.webp";
                ...
                <div id="sobre" className="flex justify-center absolute bottom-10 left-0 md:w-5/6 lg:max-w-[600px] px-5">
                    ...
                    <div className="backdrop-opacity-10 rounded-2xl bg-white px-5 py-8 bg-opacity-60 shadow-2xl shadow-stone-500/50">
                        <div className='flex gap-2'>
                            <h2 className='text-2xl md:text-4xl tracking-widest text-[#BF8B01] font-extrabold'>
                                QUEM
                            </h2>
                            <h2 className='text-2xl md:text-4xl font-bold mb-5 underline decoration-[#7C5A12] text-[#254133] underline-offset-8'>
                                SOU EU
                            </h2>
                        </div>
